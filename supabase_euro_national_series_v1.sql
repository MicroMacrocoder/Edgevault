...
from (values
  ...
  ('eur-national-de','Germany National Statistical Releases','Germany','EUR','National Statistics','data','Irregular',null,'Federal Statistical Office of Germany (Destatis)','https://www.destatis.de/EN/Home/_inhalt.html','euro-national',75,'Official Destatis release-calendar and press-release events; actual/previous values are attached from verified official Eurostat Germany series where supported.'::text,'{"calendar_only":false,"values_source":"official_eurostat_country_statistics_api","calendar_url":"https://www.destatis.de/EN/Press/Dates/Weekly-Preview-Rebrush/_inhalt.html","release_url":"https://www.destatis.de/EN/Press/press_node_2.html"}'::text),
  ...
  ('eur-national-fr','France National Statistical Releases','France','EUR','National Statistics','data','Irregular',null,'French National Institute of Statistics (INSEE)','https://www.insee.fr/en/accueil','euro-national',75,'Official INSEE publication-calendar and press-release events; actual/previous values are attached from verified official Eurostat France series where supported.'::text,'{"calendar_only":false,"values_source":"official_eurostat_country_statistics_api","calendar_url":"https://www.insee.fr/en/information/2107811","release_url":"https://www.insee.fr/en/information/2107814"}'::text),
...
where series_key in (
  ...
  'eur-national-mt', 'eur-national-bg'
);
