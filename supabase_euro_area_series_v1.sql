...
from (values
  ...
  ('eur-trade-balance','Euro Area Trade Balance','Trade','Monthly','EUR million',70,'Euro-area extra-area trade balance for total goods.', '{"dataset_code":"ext_st_easitc","numeric_values":true,"link_only":false,"frequency":"monthly","geo":"EA21","partner":"EXT_EA21","flow":"BAL_RT","product":"TOTAL"}'::text),
  ('eur-current-account','Euro Area Current Account','Trade','Quarterly','EUR million',70,'Euro-area seasonally and calendar-adjusted current-account balance.', '{"dataset_code":"bop_eu6_q","numeric_values":true,"link_only":false,"frequency":"quarterly","geo":"EA21","partner":"EXT_EA21","item":"CA","sector":"S1","adjustment":"SCA","flow":"BAL"}'::text),
